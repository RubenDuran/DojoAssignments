...
JOIN languages ON code = languages.country_code
...
-- should arrange the result by population in descending order.SELECT cities.name, cities.population FROM cities
...
LEFT JOIN countries on cities.country_code = country_code
